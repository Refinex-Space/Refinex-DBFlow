...
mutations, JSON validation errors, and omission of password hashes and reset-password plaintext.
The Testcontainers
...
| MCP client guide     | `docs/user-guide/mcp-clients.md`                                                                                                             | Codex, Claude, OpenCode, and Copilot configuration snippets plus read-only and high-risk policy smoke prompts.                                                                                                                |
...
- DBFlow administrators should use [docs/user-guide/admin-guide.md](user-guide/admin-guide.md) for management UI
  workflows, user/project-env grant/Token operations, audit review, policy viewing, and connection troubleshooting.
- Employee operators should use [docs/user-guide/operator-guide.md](user-guide/operator-guide.md) for Token request,
  MCP setup, project/env selection, safe query execution, confirmation handling, and rejection triage.
- Security and platform reviewers should use
...
- `AdminUserApiControllerTests` covers user list/filter/create/disable/enable/reset-password JSON APIs, anonymous and
  non-admin rejection, missing-CSRF rejection for mutation, JSON 4xx validation responses, and password material
  omission.
