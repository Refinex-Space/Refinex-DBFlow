...
class DbflowHealthIndicators {
    ...
    HealthIndicator dbflowTargetDatasourceRegistryHealthIndicator(DbflowHealthService healthService) {
        return () -> {
            DbflowHealthService.TargetDatasourceHealth targetHealth = healthService.targetDatasourceRegistry();
     ...
     */
    private Health toHealth(DbflowHealthService.HealthComponent component) {
